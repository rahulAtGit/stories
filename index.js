...
var closeModal = function() {
  ...
  if (storyParagraph) {
    document.getElementById("story-content").removeChild(storyParagraph);
...
var expandStory = function(id) {
  ...
  para.className = "paragraph-story";
  para.innerText = stories[id].content;
  para.id = "story-paragraph";
